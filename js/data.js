...
const TEAMS = [
  ...
  { id: 6,  n: "דרקון היער",      e: "🌿" },
  { id: 7,  n: "דרקון הכוח",      e: "💪" },
  { id: 8,  n: "דרקון האדום",     e: "🔴" },
  { id: 9,  n: "דרקון הכתום",     e: "🟠" },
  { id: 10, n: "דרקון הצהוב",     e: "🟡" },
  { id: 11, n: "דרקון הירוק",     e: "🟢" },
  { id: 12, n: "דרקון הכחול",     e: "🔵" },
  { id: 13, n: "דרקון הסגול",     e: "🟣" },
  { id: 14, n: "דרקון השחור",     e: "⚫" },
  { id: 15, n: "דרקון הלבן",      e: "⚪" },
  { id: 16, n: "דרקון הכוכב",     e: "🌟" },
  { id: 17, n: "דרקון הירח",      e: "🌙" },
  { id: 18, n: "דרקון השמש",      e: "☀️" },
  { id: 19, n: "דרקון הקשת",      e: "🌈" },
  { id: 20, n: "דרקון היהלום",    e: "💎" },
  { id: 21, n: "דרקון המלכה",     e: "👑" },
  { id: 22, n: "דרקון הנסיכה",    e: "👸" },
  { id: 23, n: "דרקון הפיה",      e: "🧚" },
  { id: 24, n: "דרקון הפלטיניום", e: "🤍" },
  { id: 25, n: "דרקון הכסף",      e: "🩶" },
  { id: 26, n: "דרקון הברזל",     e: "🖤" },
  { id: 27, n: "דרקון ההליום",    e: "🫧" },
  { id: 28, n: "דרקון הכספית",    e: "🌡️" },
  { id: 29, n: "דרקון הטיטניום",  e: "🔩" },
  { id: 30, n: "דרקון המימן",     e: "💨" }
];
